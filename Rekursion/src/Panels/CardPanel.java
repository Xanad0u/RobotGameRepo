...
import Actions.PutCardAction;
import Actions.changeRIterations;
import BasicObjects.Slot;
import BasicObjects.CardObject;
import Enums.Card;
import Enums.State;
import Globals.Main;
...
public class CardPanel extends JPanel implements MouseListener, MouseWheelListener, MouseMotionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7755314962108631139L;
	...
	public ArrayList<Slot> cardList;
